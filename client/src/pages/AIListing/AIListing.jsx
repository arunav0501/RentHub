      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
          ...
          <button
            ...
            className="mt-4 w-full py-3 bg-primary text-white rounded-xl font-semibold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="mt-3 text-xs text-slate-500 dark:text-slate-400">
            The AI only creates a draft. Always verify the product details, condition and pricing before publishing.
          </p>
        </div>
        ...
        <form onSubmit={createProduct} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea value={listing.description} onChange={event => updateField('description', event.target.value)} rows={4} className="field" />
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Category</label>
                <select value={listing.categoryId} onChange={event => updateField('categoryId', event.target.value)} className="field">
